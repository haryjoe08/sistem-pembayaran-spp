      ...
      <form id="paymentForm" method="POST" action="">
        ...
        <div class="modal-body p-4">
          <div class="alert alert-info d-flex align-items-center">
            ...
            <div>
              <strong>Jenis Tagihan:</strong> <span id="payment-type"></span>
            </div>
          </div>
        ...
        <div class="text-start">
            <table class="table table-sm">
                <tr>
                    ...
                    <td>{{ session('swal_success.siswa') }}</td>
                </tr>
                <tr>
                    <td><strong>Jenis Tagihan</strong></td>
                    <td>{{ session('swal_success.jenis_tagihan') }}</td>
                </tr>
                <tr>
                    <td><strong>Jumlah Dibayar</strong></td>
                    <td class="text-success">
                        <strong>Rp {{ number_format(session('swal_success.jumlah_bayar'), 0, ',', '.') }}</strong>
                    </td>
                </tr>
                <tr>
                    <td><strong>Total Tagihan</strong></td>
                    <td>Rp {{ number_format(session('swal_success.total'), 0, ',', '.') }}</td>
                </tr>
                <tr>
                    <td><strong>Sudah Dibayar</strong></td>
                    <td>Rp {{ number_format(session('swal_success.sudah_bayar'), 0, ',', '.') }}</td>
                </tr>

                @if(session('swal_success.status') === 'lunas')
                ...
                @else
                    <tr>
                        ...
                        <td class="text-danger">
                            <strong>Rp {{ number_format(session('swal_success.sisa'), 0, ',', '.') }}</strong>
                        </td>
                    </tr>
                    <tr>
                        <td><strong>Status</strong></td>
            ...
            @if(session('swal_success.catatan'))
                <div class="alert alert-info mt-2">
                    <small><strong>Catatan:</strong><br>
                    {{ session('swal_success.catatan') }}</small>
                </div>
            @endif
        </div>
    `
